...
<body class="tripinfo">
	...
	<table class="tripinfo_table" border="0">
		...
		<tr>
			...
			<td colspan="2" style="padding-top: 40px;"><div id="map_canvas" style="padding-bottom: 70%; width: 100%; height: 100%; z-index: 500;"></div></td>
	...
	<div class="tripinfo_buttons">
  		<button id="new" onclick="javascript:addEntry()">Neuer Eintrag</button>
