	...
	<table class="entryinfo" border="0">
		<form name="formular" action="" method="post" name="formular">
			...
			<tr>
				...
				<td colspan="2" style="padding-top: 40px;"><div id="map_canvas" style="padding-bottom: 250px; width: 100%; height: 100%; z-index: 500;"></td>
				<td colspan="3" style="padding-top: 40px; padding-left: 18px"><img id="photos" src="images/Photos.jpg" height="100%" width="100%" /></td>
			</tr>
			<tr>
				<td style="padding-top: 40px;"><button id="save" >Speichern</button></td>
				<td style="padding-top: 40px;"><button id="back" onclick="javascript:GoBack()" >Zu Tripinfo</button></td>
			</tr>
		</form>
	</table>
